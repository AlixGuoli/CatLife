...
interface AppKey {
    companion object {
        ...
        const val BROADCAST_ACTION_STATUS = "com.runrick.vplifecat.action.status"
        const val BROADCAST_ACTION_SERVICE = "com.runrick.vplifecat.action.service"
        const val BROADCAST_ACTION_ACTIVITY = "com.runrick.vplifecat.action.activity"
